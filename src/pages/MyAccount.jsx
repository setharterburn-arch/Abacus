...
const MyAccount = () => {
    ...
    return (
        <div className="container" style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
            <h1 style={{ textAlign: 'center', marginBottom: '2rem', color: '#1e3a8a' }}>My Account</h1>

            {/* Profile Summary */}
            <div style={{ background: 'white', padding: '2rem', borderRadius: '20px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)', marginBottom: '3rem', textAlign: 'center' }}>
                ...
                <h2 style={{ fontSize: '1.5rem', margin: 0 }}>Student</h2>
