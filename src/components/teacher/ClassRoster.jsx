            ...
            <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem', borderBottom: '2px solid #eee' }}>
                <button
                    ...
                    style={{
                        ...
                        background: 'none',
                        border: 'none',
                        borderBottom: activeTab === 'students' ? '3px solid var(--color-primary)' : 'none',
                        color: activeTab === 'students' ? 'var(--color-primary)' : 'var(--color-text)',
                        fontWeight: 'bold',
                        cursor: 'pointer'
                    }}
                >
                ...
                <button
                    ...
                    style={{
                        ...
                        background: 'none',
                        border: 'none',
                        borderBottom: activeTab === 'assignments' ? '3px solid var(--color-primary)' : 'none',
                        color: activeTab === 'assignments' ? 'var(--color-primary)' : 'var(--color-text)',
                        fontWeight: 'bold',
                        cursor: 'pointer'
                    }}
                >
                        ...
                        assignments.map(a => (
                            <div key={a.id} style={{
                                ...
                                <div>
                                    ...
                                    <p style={{ margin: '0.25rem 0 0 0', color: 'gray', fontSize: '0.9rem' }}>
                                        Due: {a.due_date ? new Date(a.due_date).toLocaleDateString() : 'No due date'}
                                    </p>
                                </div>
                                <button
                                    className="btn btn-secondary"
                                    style={{ color: 'red', borderColor: '#fca5a5', background: '#fee2e2' }}
                                    onClick={async () => {
